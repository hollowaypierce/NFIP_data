...
# rename flood zones for mapping
summary_df = summary_df.rename(columns = {'A': '100 year', 'X': '500 year'})
...
flood_zone_fields = ["100 year", "500 year"]

# Construct tooltip
tooltip = folium.GeoJsonTooltip(
    fields=["GEOID", "claim_count", "avgConstructionYear", "totalPaidFormatted"] + flood_zone_fields,
    aliases=[
        "Block Group GEOID:", 
        "Number of Claims:", 
        "Avg Construction Year:", 
        "Total Dollars Paid"
    ] + [f"Claims in {zone} Flood Zone (%):" for zone in flood_zone_fields],
    sticky=True,
    localize=True,
    labels=True,
    style=(
